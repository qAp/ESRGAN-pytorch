...
# Example: Start PSNR-based training from library's PSNR-based model
#python src/train.py -n 2 -g 1 -nr 0 --input_dir=./datasets --load=./parameters/psnr_based.pth --checkpoint_dir=./results/exp14  --batch_size=16 --epoch=0 --num_epoch=350 --is_perceptual_oriented=True --scale_factor=4 --fp16 --distributed

# Example: Resume a PSNR-based training.
python src/train.py -n 1 -g 1 -nr 0 --input_dir=./datasets --resume=./results/exp14/last.pth --checkpoint_dir=./results/exp14  --batch_size=16 --epoch=0 --num_epoch=350 --is_perceptual_oriented=True --scale_factor=4 --fp16 --distributed

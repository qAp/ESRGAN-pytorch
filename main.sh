...
python src/train.py -n 2 -g 1 -nr 0 --input_dir=./datasets --load=./parameters/psnr_based.pth --checkpoint_dir=./results/exp14  --batch_size=16 --epoch=0 --num_epoch=350 --is_perceptual_oriented=False --scale_factor=4 --fp16 --distributed

...
python src/train.py -n 2 -g 1 -nr 0 --input_dir=./src/datasets --load=./parameters/psnr_based.pth --checkpoint_dir=./results/checkpoints_test --is_perceptual_oriented=False --scale_factor=4 --batch_size=16 --epoch=0 --num_epoch=2 --fp16
